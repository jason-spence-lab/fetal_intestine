...
if redraw_umaps:
	...
	clusterScoreFigumap = plt.figure(dpi=80, figsize=(28,21))
	ax1 = clusterScoreFigumap.add_subplot(3,4,1)
	ax2 = clusterScoreFigumap.add_subplot(3,4,2)
	ax3 = clusterScoreFigumap.add_subplot(3,4,3)
	ax4 = clusterScoreFigumap.add_subplot(3,4,4)
	ax5 = clusterScoreFigumap.add_subplot(3,4,5)
	ax6 = clusterScoreFigumap.add_subplot(3,4,6)
	ax7 = clusterScoreFigumap.add_subplot(3,4,7)
	ax8 = clusterScoreFigumap.add_subplot(3,4,8)
	ax9 = clusterScoreFigumap.add_subplot(3,4,9)
	ax10 = clusterScoreFigumap.add_subplot(3,4,10)
	ax11 = clusterScoreFigumap.add_subplot(3,4,11)
	
	sc.pl.umap(adata, color='clust_1', save = False, show = False, legend_loc = 'on data', edges = False, size = 50, cmap = my_feature_cmap, alpha = 0.95, ax=ax1)
	sc.pl.umap(adata, color='clust_2', save = False, show = False, legend_loc = 'on data', edges = False, size = 50, cmap = my_feature_cmap, alpha = 0.95, ax=ax2)
	sc.pl.umap(adata, color='clust_3', save = False, show = False, legend_loc = 'on data', edges = False, size = 50, cmap = my_feature_cmap, alpha = 0.95, ax=ax3)
	sc.pl.umap(adata, color='clust_4', save = False, show = False, legend_loc = 'on data', edges = False, size = 50, cmap = my_feature_cmap, alpha = 0.95, ax=ax4)
	sc.pl.umap(adata, color='clust_5', save = False, show = False, legend_loc = 'on data', edges = False, size = 50, cmap = my_feature_cmap, alpha = 0.95, ax=ax5)
	sc.pl.umap(adata, color='clust_6', save = False, show = False, legend_loc = 'on data', edges = False, size = 50, cmap = my_feature_cmap, alpha = 0.95, ax=ax6)
	sc.pl.umap(adata, color='clust_7', save = False, show = False, legend_loc = 'on data', edges = False, size = 50, cmap = my_feature_cmap, alpha = 0.95, ax=ax7)
	sc.pl.umap(adata, color='clust_8', save = False, show = False, legend_loc = 'on data', edges = False, size = 50, cmap = my_feature_cmap, alpha = 0.95, ax=ax8)
	sc.pl.umap(adata, color='clust_9', save = False, show = False, legend_loc = 'on data', edges = False, size = 50, cmap = my_feature_cmap, alpha = 0.95, ax=ax9)
	sc.pl.umap(adata, color='clust_10', save = False, show = False, legend_loc = 'on data', edges = False, size = 50, cmap = my_feature_cmap, alpha = 0.95, ax=ax10)
	sc.pl.umap(adata, color='clust_11', save = False, show = False, legend_loc = 'on data', edges = False, size = 50, cmap = my_feature_cmap, alpha = 0.95, ax=ax11)
	
	
	ax1.set_title('clust_1')
	ax2.set_title('clust_2')
	ax3.set_title('clust_3')
	ax4.set_title('clust_4')
	ax5.set_title('clust_5')
	ax6.set_title('clust_6')
	ax7.set_title('clust_7')
	ax8.set_title('clust_8')
	ax9.set_title('clust_9')
	ax10.set_title('clust_10')
	ax11.set_title('clust_11')
	
	clusterScoreFigumap.savefig(''.join([figure_dir,'/UMAP_InVivo-clusters_scoring_panels.pdf']))
